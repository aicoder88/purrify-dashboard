...
const config: Config = {
  ...
  theme: {
    extend: {
      colors: {
        // Enhanced Purrify Brand Colors for Dark Theme
        charcoal: {
          50: '#f8f8f8',
          100: '#f0f0f0',
          200: '#e4e4e4',
      ...
      boxShadow: {
        ...
        'glass-hover': '0 20px 40px rgba(0, 0, 0, 0.4), 0 0 40px rgba(26, 188, 156, 0.1), inset 0 1px 0 rgba(255, 255, 255, 0.2)',
        'glow-teal': '0 0 20px rgba(26, 188, 156, 0.3)',
        'glow-teal-strong': '0 0 30px rgba(26, 188, 156, 0.5)',
